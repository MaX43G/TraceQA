...
public class DataInitializer implements ApplicationRunner {
    ...
    private void initSystemPrompts() {
        PromptDefaults.CONTENT.forEach((scenario, content) -> savePromptIfAbsent(scenario, PromptDefaults.NAMES.getOrDefault(scenario, scenario),
                content));
    }
     ...
     * 幂等写入系统提示词
     */
    private void savePromptIfAbsent(String scenario, String name, String content) {
