<template>
  <a-modal v-model:open="open" title="裁剪头像" :footer="null" :width="520" destroy-on-close>
    ...
    <div class="cropper-controls">
      <a-tooltip title="旋转">
        <a-button type="text" @click="rotate(-90)"><template #icon><RotateLeftOutlined /></template></a-button>
      </a-tooltip>
      <a-tooltip title="右旋转">
        <a-button type="text" @click="rotate(90)"><template #icon><RotateRightOutlined /></template></a-button>
      </a-tooltip>
      <a-tooltip title="缩小">
        <a-button type="text" @click="zoom(-0.1)"><template #icon><ZoomOutOutlined /></template></a-button>
      </a-tooltip>
      <a-tooltip title="放大">
        <a-button type="text" @click="zoom(0.1)"><template #icon><ZoomInOutlined /></template></a-button>
      </a-tooltip>
    </div>
