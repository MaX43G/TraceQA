 ...
 * {@code number}，两者在运行时由后端字符串转 Long 自动兼容，业务代码按
 * 生成类型使用即可。</p>
 */
...
export type DocumentProgressVO = API.DocumentProgressVO
export type SystemPromptDTO = API.SystemPromptDTO
export type AdminUserVO = API.AdminUserVO
export type RoleDTO = API.RoleDTO
export type ChatStreamRequest = API.ChatStreamRequest
export type SessionCreateRequest = API.SessionCreateRequest
